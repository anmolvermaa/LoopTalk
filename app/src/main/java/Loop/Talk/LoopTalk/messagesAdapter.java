...
import static Loop.Talk.LoopTalk.chat.reciverIImg;
import static Loop.Talk.LoopTalk.chat.senderImg;
...
public class messagesAdapter extends  RecyclerView.Adapter {
    ...
    private class senderVierwHolder extends RecyclerView.ViewHolder {
        CircleImageView circleImageView;
        TextView msgtxt;
            public senderVierwHolder(View itemview)
            {
                super(itemview);
